defmodule BlockScoutWeb.Schema.Types do
  ...
  @desc """
  Chain info data - average block time, total transactions, total blocks, wallet addresses
  """
  object :chain_data do
    field(:average_block_time, :float)
    field(:total_transactions, :integer)
    field(:total_blocks, :integer)
    field(:address_count, :integer)
  end
  ...
  @desc """
  Representation of search object
  """
  object :search_result do
    ...
    field(:foreign_token_hash, :address_hash)
