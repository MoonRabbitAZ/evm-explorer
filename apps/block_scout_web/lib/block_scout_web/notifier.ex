defmodule BlockScoutWeb.Notifier do
  ...
  alias BlockScoutWeb.Helpers.ChainData, as: ChainDataHelper
...
#        Endpoint,
#        BlockHelper.fetch_block_transaction_count(block),
#        blocks: "*"
#      )
#
#      with {:ok, chain_data} = ChainDataHelper.get_chain_data() do
#        Subscription.publish(
#          Endpoint,
#          Map.put(chain_data, :total_blocks, block.number),
#          chain_data: "*"
#        )
#      end
#
